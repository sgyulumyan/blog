...
<head>
  ...
  <link href="css/blog/blog-home.css" rel="stylesheet">
...
@foreach($posts as $post)
        ...
        <div id="blog_slides" class="bd-example">
    ...
    <a class="carousel-control-next" href="#carouselExampleCaptions" role="button" data-slide="next">
      ...
      <span class="sr-only">Next</span>
          ...
          <div class="card-body">
            ...
            <a href="/read_more/{{$post->id}}" class="btn btn-primary">Read More &rarr;</a>
          </div>
...
@endforeach
  ...
  <script src="{{ asset('js/blog/bootstrap.bundle.min.js') }}" defer></script>
  <script src="{{ asset('js/blog/jquery.min.js') }}" defer></script>
